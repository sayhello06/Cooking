...
<div id="sit_use_list">
    ...
    ?>
        <div id="sit_use_wbtn">
            <a href="<?php echo $itemuse_form; ?>" class="btn_b02 btn_s itemuse_form">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
            <a href="<?php echo $itemuse_list; ?>" class="btn_b01 btn_s itemuse_list">더보기</a>
        </div>
