...
<div class="view_wr">
    ...
    <section id="sit_use">
        ...
        <div id="itemuse" class="sit_wr"><?php include_once(G5_SHOP_PATH.'/itemuse.php'); ?></div>
    </section>
    <!-- } 사용후기 끝 -->
    ...
    <section id="sit_qa">
        ...
        <div id="itemqa" class="sit_wr"><?php include_once(G5_SHOP_PATH.'/itemqa.php'); ?></div>
    </section>
    <!-- } 상품문의 끝 -->
    ...
    <section id="sit_dvr">
        ...
        <div id="itemdv" class="sit_wr"><?php echo conv_content($default['de_baesong_content'], 1); ?></div>
    </section>
    <!-- } 배송정보 끝 -->
    <?php } ?>
    ...
    <section id="sit_ex">
        ...
        <div id="itemch" class="sit_wr"><?php echo conv_content($default['de_change_content'], 1); ?></div>
    </section>
    <!-- } 교환/반품 끝 -->
    <?php } ?>
