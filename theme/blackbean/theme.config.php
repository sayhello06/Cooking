...
$theme_config = array(
    ...
    'de_type1_list_skin'            => 'main.20.skin.php', // PC 히트상품 출력스킨
    'de_type1_list_mod'             => 4,       // PC 히트상품 출력 1줄당 이미지 수
    'de_type1_list_row'             => 3,       // PC 히트상품 출력 출력 줄 수
    'de_type1_img_width'            => 215,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 230,     // PC 히트상품 이미지 높이
    'de_type2_list_use'             => 1,       // PC 히트상품 출력
    'de_type2_list_skin'            => 'main.10.skin.php', // PC 추천상품 출력스킨
    'de_type2_list_mod'             => 5,       // PC 추천상품 출력 1줄당 이미지 수
    'de_type2_list_row'             => 1,       // PC 추천상품 출력 출력 줄 수
    'de_type2_img_width'            => 330,      // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 330,      // PC 추천상품 이미지 높이
    ...
    'de_type4_img_width'            => 180,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 180,     // PC 인기상품 이미지 높이
    ...
    'de_type5_img_width'            => 66,      // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 66,      // PC 할인상품 이미지 높이
    ...
    'de_mobile_type4_list_skin'     => 'main.40.skin.php', // 모바일 인기상품 출력스킨
    ...
    'de_search_img_width'           => 215,     // 검색상품 이미지 폭
    ...
    'ev_img_width'                  => 215,     // 이벤트 리스트 이미지 폭
