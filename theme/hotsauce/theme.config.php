...
$theme_config = array(
    ...
    'bo_mobile_gallery_width'       => 380,     // 모바일 갤러리 이미지 폭
    'bo_mobile_gallery_height'      => 240,     // 모바일 갤러리 이미지 높이
    ...
    'de_type1_list_mod'             => 3,       // PC 히트상품 출력 1줄당 이미지 수
    'de_type1_list_row'             => 2,       // PC 히트상품 출력 출력 줄 수
    'de_type1_img_width'            => 250,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 250,     // PC 히트상품 이미지 높이
    'de_type2_list_use'             => 1,       // PC 추천상품 출력
    'de_type2_list_skin'            => 'main.10.skin.php', // PC 추천상품 출력스킨
    'de_type2_list_mod'             => 3,       // PC 추천상품 출력 1줄당 이미지 수
    'de_type2_list_row'             => 2,       // PC 추천상품 출력 출력 줄 수
    'de_type2_img_width'            => 250,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 250,     // PC 추천상품 이미지 높이
    'de_type3_list_use'             => 1,       // PC 최신상품 출력
    'de_type3_list_skin'            => 'main.10.skin.php', // PC 최신상품 출력스킨
    'de_type3_list_mod'             => 3,       // PC 최신상품 출력 1줄당 이미지 수
    'de_type3_list_row'             => 2,       // PC 최신상품 출력 출력 줄 수
    'de_type3_img_width'            => 250,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 250,     // PC 최신상품 이미지 높이
    'de_type4_list_use'             => 1,       // PC 인기상품 출력
    'de_type4_list_skin'            => 'main.10.skin.php', // PC 인기상품 출력스킨
    'de_type4_list_mod'             => 3,       // PC 인기상품 출력 1줄당 이미지 수
    'de_type4_list_row'             => 2,       // PC 인기상품 출력 출력 줄 수
    'de_type4_img_width'            => 250,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 250,     // PC 인기상품 이미지 높이
    'de_type5_list_use'             => 1,       // PC 할인상품 출력
    'de_type5_list_skin'            => 'main.10.skin.php', // PC 할인상품 출력스킨
    'de_type5_list_mod'             => 3,       // PC 할인상품 출력 1줄당 이미지 수
    'de_type5_list_row'             => 2,       // PC 할인상품 출력 출력 줄 수
    'de_type5_img_width'            => 250,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 250,     // PC 할인상품 이미지 높이
    ...
    'de_mobile_type1_img_width'     => 250,     // 모바일 히트상품 이미지 폭
    'de_mobile_type1_img_height'    => 250,     // 모바일 히트상품 이미지 높이
    ...
    'de_mobile_type2_img_width'     => 250,     // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height'    => 250,     // 모바일 추천상품 이미지 높이
    ...
    'de_mobile_type3_list_row'      => 7,       // 모바일 최신상품 출력 출력 줄 수
    'de_mobile_type3_img_width'     => 250,     // 모바일 최신상품 이미지 폭
    'de_mobile_type3_img_height'    => 250,     // 모바일 최신상품 이미지 높이
    'de_mobile_type4_list_use'      => 1,       // 모바일 인기상품 출력
    'de_mobile_type4_list_skin'     => 'main.20.skin.php', // 모바일 인기상품 출력스킨
    'de_mobile_type4_list_mod'      => 10,       // 모바일 인기상품 출력 1줄당 이미지 수
    'de_mobile_type4_list_row'      => 1,       // 모바일 인기상품 출력 출력 줄 수
    'de_mobile_type4_img_width'     => 400,     // 모바일 인기상품 이미지 폭
    'de_mobile_type4_img_height'    => 400,     // 모바일 인기상품 이미지 높이
    ...
    'de_mobile_type5_img_width'     => 250,     // 모바일 할인상품 이미지 폭
    'de_mobile_type5_img_height'    => 250,     // 모바일 할인상품 이미지 높이
    'de_rel_list_use'               => 1,       // 관련상품 출력
    'de_rel_list_skin'              => 'relation.10.skin.php',  // 관련상품 출력 스킨
    'de_rel_list_mod'               => 3,       // 관련상품 1줄당 이미지 수
    ...
    'de_mobile_rel_list_mod'        => 6,       // 모바일 관련상품 1줄당 이미지 수
    'de_mobile_rel_img_width'       => 250,     // 모바일 관련상품 이미지 폭
    'de_mobile_rel_img_height'      => 250,     // 모바일 관련상품 이미지 높이
    'de_search_list_skin'           => 'list.10.skin.php',  // 검색상품 출력 스킨
    'de_search_list_mod'            => 4,       // 검색상품 1줄당 이미지 수
    'de_search_list_row'            => 4,       // 검색상품 출력 줄 수
    ...
    'de_mobile_search_list_row'     => 4,       // 모바일 검색상품 출력 줄 수
    'de_mobile_search_img_width'    => 250,     // 모바일 관련상품 이미지 폭
    'de_mobile_search_img_height'   => 250,     // 모바일 관련상품 이미지 높이
    'de_mimg_width'                 => 230,     // 상품상세 이미지 Width
    'de_mimg_height'                => 230,     // 상품상세 이미지 Height
    'ca_skin'                       => 'list.10.skin.php',  // 분류 리스트 스킨
    'ca_img_width'                  => 230,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 230,     // 분류 리스트 이미지 높이
    'ca_list_mod'                   => 3,       // 분류 리스트 1줄당 이미지 수
    'ca_list_row'                   => 4,       // 분류 리스트 이미지 줄 수
    'ca_mobile_skin'                => 'list.10.skin.php',  // 모바일 분류 리스트 스킨
    'ca_mobile_img_width'           => 250,     // 모바일 분류 리스트 이미지 폭
    'ca_mobile_img_height'          => 250,     // 모바일 분류 리스트 이미지 높이
    'ca_mobile_list_mod'            => 4,       // 모바일 분류 리스트 1줄당 이미지 수
    'ca_mobile_list_row'            => 4,       // 모바일 분류 리스트 이미지 줄 수
    'ev_skin'                       => 'list.10.skin.php',  // 이벤트 출력 스킨
    'ev_img_width'                  => 230,     // 이벤트 리스트 이미지 폭
    'ev_img_height'                 => 230,     // 이벤트 리스트 이미지 높이
    'ev_list_mod'                   => 3,       // 이벤트 리스트 1줄당 이미지 수
    'ev_list_row'                   => 5,       // 이벤트 리스트 이미지 줄 수
    'ev_mobile_skin'                => 'list.10.skin.php',  // 모바일 이벤트 출력 스킨
    'ev_mobile_img_width'           => 250,     // 모바일 이벤트 리스트 이미지 폭
    'ev_mobile_img_height'          => 250,     // 모바일 이벤트 리스트 이미지 높이
    'ev_mobile_list_mod'            => 4,       // 모바일 이벤트 1줄당 이미지 수
    'ev_mobile_list_row'            => 5,       // 모바일 이벤트 이미지 줄 수
    'ca_mobile_list_best_mod'       => 4,       // 모바일 상품리스트 베스트상품 1줄당 이미지 수
