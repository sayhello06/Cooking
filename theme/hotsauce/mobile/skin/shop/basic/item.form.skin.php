...
<div id="sit_ov_wrap">
    ...
    <div id="sit_star_sns">
		<div id="sit_star">
	        ...
	        <img src="<?php echo G5_SHOP_URL; ?>/img/s_star<?php echo $score?>.png" alt="고객평점 <?php echo $score?>개" class="sit_star">
	        <strong><?php echo $score?></strong> 점
	        <?php } ?>
		</div>
		<div class="sns_area">
