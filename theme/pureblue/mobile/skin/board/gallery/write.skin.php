    ...
    if ($is_notice || $is_html || $is_secret || $is_mail) { 
        ...
        if ($is_html) {
            if ($is_dhtml_editor) {
                ...
                $option .= PHP_EOL.'<input type="checkbox" id="html" name="html" onclick="html_auto_br(this);" class="selec_chk" value="'.$html_value.'" '.$html_checked.'>'.PHP_EOL.'<label for="html">html</label>';
			}
        }
        if ($is_secret) {
    ...
    <div class="form_inpt">
		...
		<ul class="bo_w_info">
	        ...
	        <li>
	            ...
	            <div class="wli_cnt">
	            	<select id="ca_name" name="ca_name" required class="frm_input full_input">
