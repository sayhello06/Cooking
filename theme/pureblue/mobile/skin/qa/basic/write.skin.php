        ...
        <ul class="bo_w_info">
            ...
            <li>
				...
				<div class="wli_cnt bo_w_mail">
	                ...
	                <input type="email" name="qa_email" value="<?php echo get_text($write['qa_email']); ?>" id="qa_email" <?php echo $req_email; ?> class="<?php echo $req_email.' '; ?>full_input email" maxlength="100" placeholder="이메일">
            ...
            <li>
				...
				<div class="wli_cnt bo_w_mail">
	                ...
	                <input type="text" name="qa_hp" value="<?php echo get_text($write['qa_hp']); ?>" id="qa_hp" <?php echo $req_hp; ?> class="<?php echo $req_hp.' '; ?>full_input" size="30" placeholder="휴대폰">
            ...
            <li>
				...
				<div class="wli_cnt bo_w_mail">
                	...
                	<input type="text" name="qa_subject" value="<?php echo get_text($write['qa_subject']); ?>" id="qa_subject" required class="full_input required" maxlength="255" placeholder="제목">
            	</div>
            </li>
