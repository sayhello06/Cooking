...
$theme_config = array(
    ...
    'de_mobile_type1_list_mod'      => 3,       // 모바일 히트상품 출력 1줄당 이미지 수
    'de_mobile_type1_list_row'      => 2,       // 모바일 히트상품 출력 출력 줄 수
    'de_mobile_type1_img_width'     => 320,     // 모바일 히트상품 이미지 폭
    'de_mobile_type1_img_height'    => 320,     // 모바일 히트상품 이미지 높이
    ...
    'de_mobile_type2_list_row'      => 3,       // 모바일 추천상품 출력 출력 줄 수
    'de_mobile_type2_img_width'     => 400,     // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height'    => 400,     // 모바일 추천상품 이미지 높이
    ...
    'de_mobile_type3_list_row'      => 3,       // 모바일 최신상품 출력 출력 줄 수
    'de_mobile_type3_img_width'     => 400,     // 모바일 최신상품 이미지 폭
    'de_mobile_type3_img_height'    => 400,     // 모바일 최신상품 이미지 높이
    'de_mobile_type4_list_use'      => 1,       // 모바일 인기상품 출력
    'de_mobile_type4_list_skin'     => 'main.30.skin.php', // 모바일 인기상품 출력스킨
    'de_mobile_type4_list_mod'      => 3,       // 모바일 인기상품 출력 1줄당 이미지 수
    'de_mobile_type4_list_row'      => 2,       // 모바일 인기상품 출력 출력 줄 수
    'de_mobile_type4_img_width'     => 320,     // 모바일 인기상품 이미지 폭
    'de_mobile_type4_img_height'    => 320,     // 모바일 인기상품 이미지 높이
    'de_mobile_type5_list_use'      => 1,       // 모바일 할인상품 출력
    'de_mobile_type5_list_skin'     => 'main.30.skin.php', // 모바일 할인상품 출력스킨
    'de_mobile_type5_list_mod'      => 3,       // 모바일 할인상품 출력 1줄당 이미지 수
    'de_mobile_type5_list_row'      => 2,       // 모바일 할인상품 출력 출력 줄 수
    'de_mobile_type5_img_width'     => 320,     // 모바일 할인상품 이미지 폭
    'de_mobile_type5_img_height'    => 320,     // 모바일 할인상품 이미지 높이
    ...
    'ca_mobile_list_best_row'       => 2,       // 모바일 상품리스트 베스트상품 이미지 줄 수
	'theme_bn_order'                => 27,      // 테마 데모에서 테마별 보여줄 bn_order 값
);
?>