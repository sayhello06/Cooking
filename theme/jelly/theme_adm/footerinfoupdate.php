...
@mkdir(G5_DATA_PATH."/cache/theme/jelly", G5_DIR_PERMISSION);
@chmod(G5_DATA_PATH."/cache/theme/jelly", G5_DIR_PERMISSION);
...
$save_file = G5_DATA_PATH.'/cache/theme/jelly/footerinfo.php';
