...
<div id="mb_login" class="mbskin">
    <div class="mbskin_box">
		...
		<div class="mbskin_box_login_t"><span><?php echo $config['cf_title']; ?><b> <?php echo $default['de_admin_company_name']; ?></b></span> 로그인해 주십시요</div>
        ...
        <fieldset id="login_fs">
			...
			<div id="login_info_text">
			 ...
			 <p class="login_info_text3"><span class="login_info_text4">다양한 혜택(쿠폰과 포인트)을 드립니다</span></p>
			</div>

			<div id="mb_log_cate2"><a href="<?php echo G5_BBS_URL ?>/register.php" class="join">회원가입</a></div>
        </fieldset> 
        </form>
