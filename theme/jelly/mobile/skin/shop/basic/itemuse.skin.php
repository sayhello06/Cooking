...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="qa_wr btn_b02 itemuse_form btn_m" onclick="return false;">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
    <a href="<?php echo $itemuse_list; ?>" id="itemuse_list" class="btn_b01 btn btn_m">더보기</a>
</div>
