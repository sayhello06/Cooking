...
$theme_config = array(
    ...
    'de_type1_list_row'             => 1,       // PC 히트상품 출력 출력 줄 수
    'de_type1_img_width'            => 110,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 110,     // PC 히트상품 이미지 높이
    'de_type2_list_use'             => 1,       // PC 추천상품 출력
    'de_type2_list_skin'            => 'main.30.skin.php', // PC 추천상품 출력스킨
    'de_type2_list_mod'             => 4,       // PC 추천상품 출력 1줄당 이미지 수
    'de_type2_list_row'             => 1,       // PC 추천상품 출력 출력 줄 수
    'de_type2_img_width'            => 110,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 110,     // PC 추천상품 이미지 높이
    'de_type3_list_use'             => 1,       // PC 최신상품 출력
    'de_type3_list_skin'            => 'main.10.skin.php', // PC 최신상품 출력스킨
    'de_type3_list_mod'             => 5,       // PC 최신상품 출력 1줄당 이미지 수
    'de_type3_list_row'             => 1,       // PC 최신상품 출력 출력 줄 수
    'de_type3_img_width'            => 285,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 285,     // PC 최신상품 이미지 높이
    ...
    'de_type5_img_width'            => 110,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 110,     // PC 할인상품 이미지 높이
    ...
    'de_mobile_type2_img_width'     => 230,     // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height'    => 230,     // 모바일 추천상품 이미지 높이
    ...
    'de_mobile_type3_list_row'      => 2,       // 모바일 최신상품 출력 출력 줄 수
    'de_mobile_type3_img_width'     => 230,     // 모바일 최신상품 이미지 폭
    'de_mobile_type3_img_height'    => 230,     // 모바일 최신상품 이미지 높이
    ...
    'de_rel_img_width'              => 250,     // 관련상품 이미지 폭
    'de_rel_img_height'             => 250,     // 관련상품 이미지 높이
    ...
    'de_search_img_width'           => 285,     // 검색상품 이미지 폭
    'de_search_img_height'          => 285,     // 검색상품 이미지 높이
    ...
    'de_mimg_width'                 => 500,     // 상품상세 이미지 Width
    'de_mimg_height'                => 500,     // 상품상세 이미지 Height
    'ca_skin'                       => 'list.10.skin.php',  // 분류 리스트 스킨
    'ca_img_width'                  => 285,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 285,     // 분류 리스트 이미지 높이
...
if(!defined('G5_IS_ADMIN'))
    ...
    define('G5_THEME_ADM_DIR', 'theme/pancake/theme_adm/footerinfo.php');
