...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div class="con_left"> 
            ...
            <div class="ssch_scharea">
                ...
                <div class="ssch_con">
                    ...
                    <input type="checkbox" name="qname" id="ssch_qname" value="1" <?php echo $qname_check?'checked="checked"':'';?>> <label for="ssch_qname">상품명</label><br>
                    <input type="checkbox" name="qexplan" id="ssch_qexplan" value="1" <?php echo $qexplan_check?'checked="checked"':'';?>> <label for="ssch_qexplan">상품설명</label> <br>
                    ...
                    <input type="checkbox" name="qid" id="ssch_qid" value="1" <?php echo $qid_check?'checked="checked"':'';?>> <label for="ssch_qid">상품코드</label>   <br>
        ...
        if (file_exists($list_file)) {
            if(! defined('G5_SHOP_CSS_URL')) define('G5_SHOP_CSS_URL', G5_MSHOP_SKIN_URL);
