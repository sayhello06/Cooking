...
<section id="sit_use_list">
    ...
    <div class="sit_use_top">
        ...
        <div id="sit_use_wbtn">
            <a href="<?php echo $itemuse_form; ?>" class="btn_b02 itemuse_form">사용후기 쓰기<span class="sound_only"> 새 창</span></a>
            <a href="<?php echo $itemuse_list; ?>" class="btn_b01 itemuse_list">더보기</a>
        </div>
    </div>
    <?php
    $thumbnail_width = 500;
