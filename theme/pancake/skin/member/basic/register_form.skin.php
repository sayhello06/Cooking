...
<div class="register">
    ...
    <div id="register_form" class="form_01">   
        <div class="register_form_inner">
            ...
            <ul>
                <li>
                    <label for="reg_mb_id" class="sound_only">
                        아이디 (필수)
                    </label>
        ...
        <div class="tbl_frm01 tbl_wrap register_form_inner">
            ...
            <ul>
                ...
                <li>
                    <label class="sound_only">주소</label>
        ...
        <div class="tbl_frm01 tbl_wrap register_form_inner">
            ...
            <ul>
                ...
                <li>
                    ...
                    <span class="frm_info">이미지 크기는 가로 <?php echo $config['cf_member_icon_width'] ?>픽셀, 세로 <?php echo $config['cf_member_icon_height'] ?>픽셀 이하로 해주세요.<br>
                ...
                <li class="reg_mb_img_file">
                    ...
                    <span class="frm_info">이미지 크기는 가로 <?php echo $config['cf_member_img_width'] ?>픽셀, 세로 <?php echo $config['cf_member_img_height'] ?>픽셀 이하로 해주세요.<br>
